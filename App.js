...
export default class App extends Component {
  ...
  async getDonor() {
    return fetch(
      `https://blood-app-db-9ef26-default-rtdb.firebaseio.com/donors.json`
    )
      ...
      <Container>
        ...
        <Content style={{ marginLeft: 10, marginRight: 10 }}>
          <View style={{ backgroundColor: "#f2eded", marginTop: 10 }}>
            {this.state.isSubmited ? (
              <TouchableOpacity onPress={() => this._toggleDonorPost()}>
                <Text style={{ fontSize: 20, color: "#770707" }}>
                  Add more donors
                </Text>
              </TouchableOpacity>
            ) : (
          ...
          <View>
            ...
            >
              <Text
                style={{ fontSize: 15, fontWeight: "bold", color: "#e89494" }}
              >
                DONORS
              </Text>
            </View>
